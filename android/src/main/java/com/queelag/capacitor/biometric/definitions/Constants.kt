...
object Core {
    const val ASYMMETRIC_KEYS_ALIAS = "ARACNA_BIOMETRIC_ASYMMETRIC_KEYS"
    ...
    const val SHARED_PREFERENCES = "ARACNA_BIOMETRIC_SHARED_PREFERENCES"
    const val SYMMETRIC_KEY_ALGORITHM = "AES"
    const val SYMMETRIC_KEY_ALIAS = "ARACNA_BIOMETRIC_SYMMETRIC_KEY"
